...
class OTPReceived extends StatelessWidget {
  ...
  OTPReceived({Key key, @required this.email}) : super(key: key);
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        resendVerificationMail(email).then((result){
                              ...
                              Container(
                                ...
                                child: InkWell(
                                  ...
                                  child: RaisedButton(
                                    ...
                                    onPressed: () {
                                      verifyingIdentityPhone(
                                          _tokenNb1.text + _tokenNb2.text +
                                              _tokenNb3.text + _tokenNb4.text).then((result){
                                                print(result);
                                                if((result['status']['code'] == 401) || (result['status']['code'] == 403) || (result['status']['code'] == 404)){
                                                  showDialog(
                                                      context: context,
                                                      builder: (BuildContext context) {
                                                        return DialogScreen(
